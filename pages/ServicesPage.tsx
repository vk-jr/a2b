                ...
                <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                        {SERVICES.map((service) => (
                             <div key={service.name} className="bg-secondary p-8 rounded-xl border border-gray-700/50 hover:border-accent/50 transition-all duration-300 transform hover:-translate-y-1 flex flex-col">
                                {service.icon}
                                <h3 className="text-xl font-bold font-display text-light">{service.name}</h3>
                                <p className="mt-2 text-medium flex-grow">{service.description}</p>
            ...
            <section className="py-20 sm:py-24 bg-secondary">
                <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="text-center">
                        <h2 className="text-3xl font-display font-bold">Custom AI Agent Development</h2>
                    </div>
                    <div className="grid md:grid-cols-2 gap-12 mt-12 items-center">
                        <div>
                            ...
                            <h4 className="font-bold text-light mt-6 mb-2">Key Features:</h4>

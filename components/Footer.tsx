...
const Footer: React.FC = () => {
  return (
    <footer className="bg-secondary text-medium border-t border-gray-700">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-4 lg:grid-cols-5 gap-12">
          
          <div className="lg:col-span-2">
            <Link to="/" className="text-3xl font-display font-bold text-light">
          ...
          <div>
            <h3 className="font-bold text-light tracking-wider uppercase">Solutions</h3>
          ...
          <div>
            <h3 className="font-bold text-light tracking-wider uppercase">Company</h3>
            <ul className="mt-4 space-y-3">
          ...
          <div>
            <h3 className="font-bold text-light tracking-wider uppercase">Newsletter</h3>
            <p className="mt-4">Get the latest AI trends and insights from our experts.</p>
            <form className="mt-4 flex flex-col sm:flex-row">
              <input type="email" placeholder="Your Email" className="w-full px-4 py-2 rounded-md bg-primary border border-gray-600 focus:outline-none focus:ring-2 focus:ring-accent" />
